...
key_size = 70
keys = [
    ("Q", (50, 100)), ("W", (150, 100)), ("E", (250, 100)), ("R", (350, 100)), ("T", (450, 100)), ("Y", (550, 100)), ("U", (650, 100)), ("I", (750, 100)), ("O", (850, 100)), ("P", (950, 100)),
    ("A", (50, 200)), ("S", (150, 200)), ("D", (250, 200)), ("F", (350, 200)), ("G", (450, 200)), ("H", (550, 200)), ("J", (650, 200)), ("K", (750, 200)), ("L", (850, 200)), ("Backspace", (950, 200)),
    ("Z", (50, 300)), ("X", (150, 300)), ("C", (250, 300)), ("V", (350, 300)), ("B", (450, 300)), ("N", (550, 300)), ("M", (650, 300))
]
...
# Counting selected letters
letter_counts = {key: 0 for key, _ in keys}

# Function to draw keyboard with black keys and red borders
def draw_keyboard(image, keys, selected_key):
    for key, pos in keys:
        ...
        if key == selected_key:
            ...
            cv2.rectangle(image, (x, y), (x + key_size, y + key_size), (0, 0, 255), 2)  # Red border
            cv2.putText(image, key, (x + 15, y + 45), cv2.FONT_HERSHEY_PLAIN, 2, (0, 0, 255), 2)  # Red text
...
with mp_hands.Hands(max_num_hands=1, min_detection_confidence=0.5) as hands:
    while cap.isOpened():
        ...
        if not success:
            output_file.write("Ignoring empty camera frame.\n")
            continue
                        ...
                        if not key_pressed:
                            if key == last_selected_key and (cv2.getTickCount() - last_key_time) / cv2.getTickFrequency() < 1.0:
                                ...
                                if key == "Backspace":
                                    ...
                                    selected_keys += key
                                    letter_counts[key] += 1  # Increment count for the selected letter
                                    output_file.write(f"Selected Key: {key}\n")  # Write to output file
